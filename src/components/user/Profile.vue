      ...
      <v-row>
        <v-col sm="8" offset-sm="2">
          ...
          <v-row justify="center" class="mb-5"
            ><v-avatar size="128">
              <img :src="imageUrl" :alt="user.name" /> </v-avatar
          ></v-row>
          ...
          <v-row>
            <v-col>
              <v-row class="mt-5">
                ...
                <v-col cols="6">
                  <router-link v-if="eventsCreated > 0" to="/events/created">
                    <v-badge color="info" :content="eventsCreated" inline>
                    </v-badge
                  ></router-link>
                  <v-badge v-else color="error" :content="eventsCreated" inline>
                  </v-badge>
                </v-col>
              </v-row>
              <v-row>
                ...
                <v-col cols="6">
                  <router-link v-if="eventsJoined > 0" to="/events/joined">
                    <v-badge color="info" :content="eventsJoined" inline>
                    </v-badge>
                  </router-link>
                  <v-badge v-else color="error" :content="eventsJoined" inline>
                  </v-badge>
                </v-col>
              </v-row>
            </v-col>
            ...
            <v-dialog v-model="terminateDialog" width="300">
              <v-card>
                <v-card-title class="headline"
                  >Close your account?</v-card-title
                >
